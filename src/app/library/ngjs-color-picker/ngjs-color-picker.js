    ...
    .directive('ngjsColorPicker', function() {
        ...
        return {
            ...
            link: function (scope, element, attr) {
                ...
                scope.options.margin = scope.options.margin || 2;
                ...
                if(scope.options.columns > 0){
                    ...
                    scope.ulCss.width = scope.options.columns*(parseInt(scope.css.width.substr(0,indexOfPx))+ parseInt(scope.options.margin) * 2) + 'px';
